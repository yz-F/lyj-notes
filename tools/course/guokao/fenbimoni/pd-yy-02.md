...
### 09共15道，答对9道，正确率60%，用时24分钟
- 1（错两次：无中生有，A项，文段侧重强调“氡观测仪无法实现全国统一校准”，未提及“氡观测仪器”难以在全国应用 2. 这道题是问题，总结填写对策。对策不仅跟主题词地震前岩石中氡值有关，并且后文又提及了问题：由于监测仪器标准不统一。所以应该跟这两个有关提对策。选C）
...
```
###  共15道，答对11道，正确率73%，
- 1（属于3.要专攻！并且记住并列的用法，并且表并列，连接的两个句子意思应该是差不多相同的。④句通过并列关联词来进一步论述“座椅”的数量、位置设计等要满足车站和旅客的要求，仍然是在介绍“座椅”的作用，可与②句构成并列关系，）
...
- 2（属于3，要qian有时候尾句不一定只有总结功能，有时候也要管话题一致。话题一致很重要。要讲上一个实验的结果也就是C）
...
故正确答案为B。
```
- 3（属于3，专攻！②“随着”引导背景，随着，引入背景，有首句特征。）
...
正确答案是： C，你的答案是： A收起
解析
观察选项，对比首句。⑤论述各地物候无法用同一标尺表述，③提及各地的物候情况，②“随着”引导背景，④阐述“古老的物候”，相比较，②为背景引入，更适合作首句，故初步锁定C项。验证，②提及气候无通例，③⑤具体解释②的内容，④提及古老的物候好，①“于是”表示总结，“需要”引导对策，具有明显尾句特征，且选项整体逻辑恰当，验证正确。

故正确答案为C。
```
- 4（属于3，专攻！没有首句特征，但是32，有代词这。直接捆绑，选出C）
...
正确答案是： C，你的答案是： A收起
解析
对比选项，确定首句。对比①④⑤⑥，难以判断首句，进而寻找其他线索。②句中出现指代词“这”，阐述“为食肉动物提供······食物来源”，根据指代内容可知，代词指代内容应为③句中的“猛犸象、驯鹿、野牛”，故③句、②句根据指代词可进行捆绑，锁定C项。
